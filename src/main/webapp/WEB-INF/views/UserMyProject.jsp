										...
										<tbody>
											<c:forEach items="${pu}" var="project">
												<tr>
													...
													<td>
													<a class="btn btn-primary btn-sm" href="usermymodule?projectId=${project.projectId}">Module</a>
													|
													<a class="btn btn-info btn-sm" href="userlistprojectuser?projectId=${project.projectId}">Team</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
